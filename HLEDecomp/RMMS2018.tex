...
2004, and 2014. We calculate healthy, disabled, and total life expectancy using
incidence-based Markov matrix models. We decompose the difference between time
points and population strata into 9 separate age-specific components for onset,
