...
\subfloat[][1996-2006]{
      \begin{tabular}{rrr|r}
      \input{Data/Tables/mspec06/m-1996-2006-struct.tex}
     \end{tabular}
}
~
\subfloat[][2006-2014]{
      \begin{tabular}{rrr|r}
      \input{Data/Tables/mspec06/m-2006-2014-struct.tex}
     \end{tabular}
}
\end{table}
...
\subfloat[][1996-2006]{
      \begin{tabular}{rrr|r}
      \input{Data/Tables/mspec06/f-1996-2006-struct.tex}
     \end{tabular}
}
~
\subfloat[][2006-2014]{
      \begin{tabular}{rrr|r}
      \input{Data/Tables/mspec06/f-2006-2014-struct.tex}
     \end{tabular}
}
\end{table}
...
%Potential improvements may be in store on a 20-year horizon due to compositional differences already determined today in better-educated younger ages, but also due to preventative, technological, and policy changes that affect transitions into and recovery from disability, and that would require investment. While there are forthcoming boosts to LE due to the better educational attainment of younger generations, much of the improvement in life expectancy observed over the past 20 years is net of group differences in disability and educational attainment, meaning it is driven by something else that we are not accounting for.
%\section{Conclusions}
