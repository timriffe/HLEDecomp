...
\pause
They're all *good enough* for what we're doing
...
\Large
For standard calcs we use (two of) [$p^{stay}$, $p^{switch}$, $p^{die}$]

\pause
Transform two multiplicative probabilities [$p^{stay} | survive$, $p^{survive}$]
